...
var WOW;jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, { def: "easeOutQuad", swing: function swing(t, e, i, n, a) {
  ...
  return function (t, e, i, n) {
    function a(t) {
      ...
      function r(t, e) {
        ...
        } while (Math.abs(r) > g && ++s < m);return o;
      }function h() {
      ...
      var i = t;return f.isString(t) ? v.Easings[t] || (i = !1) : i = f.isArray(t) && 1 === t.length ? function (t) {
        return function (e) {
      ...
      if (t) {
        var e = new Date().getTime(),
            i = v.State.calls.length;i > 1e4 && (v.State.calls = function (t) {
          for (var e = -1, i = t ? t.length : 0, n = []; ++e < i;) {
            var a = t[e];a && n.push(a);
          }return n;
        }(v.State.calls));for (var a = 0; i > a; a++) {
          if (v.State.calls[a]) {
            var o = v.State.calls[a],
                ...
                h = o[3],
                p = !!h,
                g = null;h || (h = v.State.calls[a][3] = e - 16);for (var m = Math.min((e - h) / c.duration, 1), b = 0, x = s.length; x > b; b++) {
              var k = s[b],
                  S = k.element;if (r(S)) {
                var C = !1;if (c.display !== n && null !== c.display && "none" !== c.display) {
                  ...
                  if ("element" !== M) {
                    var P,
                        T = k[M],
                        A = f.isString(T.easing) ? v.Easings[T.easing] : T.easing;if (1 === m) P = T.endValue;else {
                      var _ = T.endValue - T.startValue;if (P = T.startValue + _ * A(m, c, _), !p && P === T.currentValue) continue;
                    }if (T.currentValue = P, "tween" === M) g = P;else {
                      if (y.Hooks.registered[M]) {
                        var I = y.Hooks.getRoot(M),
                            D = r(S).rootPropertyValueCache[I];D && (T.rootPropertyValue = D);
                      }var F = y.setPropertyValue(S, M, T.currentValue + (0 === parseFloat(P) ? "" : T.unitType), T.rootPropertyValue, T.scrollData);y.Hooks.registered[M] && (r(S).rootPropertyValueCache[I] = y.Normalizations.registered[I] ? y.Normalizations.registered[I]("extract", null, F[1]) : F[1]), "transform" === F[0] && (C = !0);
                    }
                  }
      ...
      if (!v.State.calls[t]) return !1;for (var i = v.State.calls[t][0], a = v.State.calls[t][1], o = v.State.calls[t][2], s = v.State.calls[t][4], l = !1, u = 0, c = i.length; c > u; u++) {
      ...
      }v.State.calls[t] = !1;for (var p = 0, g = v.State.calls.length; g > p; p++) {
      ...
      var g = 400,
          m = "swing",
          v = { State: { isMobile: /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), isAndroid: /Android/i.test(navigator.userAgent), isGingerbread: /Android 2\.3\.[3-7]/i.test(navigator.userAgent), isChrome: e.chrome, isFirefox: /Firefox/i.test(navigator.userAgent), prefixElement: i.createElement("div"), prefixMatches: {}, scrollAnchor: null, scrollPropertyLeft: null, scrollPropertyTop: null, isTicking: !1, calls: [] }, CSS: {}, Utilities: d, Redirects: {}, Easings: {}, Promise: e.Promise, defaults: { queue: "", duration: g, easing: m, begin: n, complete: n, progress: n, display: n, visibility: n, loop: !1, delay: !1, mobileHA: !0, _cacheValues: !0 }, init: function init(t) {
        ...
        }, hook: null, mock: !1, version: { major: 1, minor: 2, patch: 2 }, debug: !1 };e.pageYOffset !== n ? (v.State.scrollAnchor = e, v.State.scrollPropertyLeft = "pageXOffset", v.State.scrollPropertyTop = "pageYOffset") : (v.State.scrollAnchor = i.documentElement || i.body.parentNode || i.body, v.State.scrollPropertyLeft = "scrollLeft", v.State.scrollPropertyTop = "scrollTop");var b = function () {
        function t(t) {
      ...
      }();v.Easings = { linear: function linear(t) {
          return t;
        ...
        v.Easings[e[0]] = o.apply(null, e[1]);
            ...
            9 >= c || v.State.isGingerbread || (y.Lists.transformsBase = y.Lists.transformsBase.concat(y.Lists.transforms3D));for (var t = 0; t < y.Lists.transformsBase.length; t++) {
              !function () {
                var e = y.Lists.transformsBase[t];y.Normalizations.registered[e] = function (t, i, a) {
                  switch (t) {case "name":
                      ...
                      var o = !1;switch (e.substr(0, e.length - 1)) {case "translate":
                          ...
                          v.State.isAndroid && r(i).transformCache[e] === n && 1 > a && (a = 1), o = !/(\d)$/i.test(a);break;case "skew":
            ...
            var e = "width|height|x|y|cx|cy|r|rx|ry|x1|x2|y1|y2";return (c || v.State.isAndroid && !v.State.isChrome) && (e += "|transform"), new RegExp("^(" + e + ")$", "i").test(t);
          }, prefixCheck: function prefixCheck(t) {
            if (v.State.prefixMatches[t]) return [v.State.prefixMatches[t], !0];for (var e = ["", "Webkit", "Moz", "ms", "O"], i = 0, n = e.length; n > i; i++) {
          ...
          } else l = s(t, y.Names.prefixCheck(i)[0]);return y.Values.isCSSNullValue(l) && (l = 0), v.debug >= 2 && console.log("Get " + i + ": " + l), l;
          ...
          var s = i;if ("scroll" === i) o.container ? o.container["scroll" + o.direction] = n : "Left" === o.direction ? e.scrollTo(n, o.alternateValue) : e.scrollTo(o.alternateValue, n);else if (y.Normalizations.registered[i] && "transform" === y.Normalizations.registered[i]("name", t)) y.Normalizations.registered[i]("inject", t, n), s = "transform", n = r(t).transformCache[i];else {
            ...
            } else r(t) && r(t).isSVG && y.Names.SVGAttribute(i) ? t.setAttribute(i, n) : t.style[s] = n;v.debug >= 2 && console.log("Set " + i + " (" + s + "): " + n);
          }return [s, n];
        }, flushTransformCache: function flushTransformCache(t) {
          function e(e) {
            return parseFloat(y.getPropertyValue(t, e));
          }var i = "";if ((c || v.State.isAndroid && !v.State.isChrome) && r(t).isSVG) {
        ...
        var o = n;return t = a(t), d.each(t, function (t, a) {
          if (r(a) === n && v.init(a), i === n) o === n && (o = v.CSS.getPropertyValue(a, e));else {
            var s = v.CSS.setPropertyValue(a, e, i);"transform" === s[0] && v.CSS.flushTransformCache(a), o = s;
          }
        }), o;
      };var x = function x() {
        function t() {
          ...
          function t(t) {
            function h(t, e) {
              ...
              var t = { myParent: o.parentNode || i.body, position: y.getPropertyValue(o, "position"), fontSize: y.getPropertyValue(o, "fontSize") },
                ...
                var u = r(o).isSVG ? i.createElementNS("http://www.w3.org/2000/svg", "rect") : i.createElement("div");v.init(u), t.myParent.appendChild(u), d.each(["overflow", "overflowX", "overflowY"], function (t, e) {
              ...
              var x,
                  ...
                  _ = parseFloat(u.offset) || 0;u.container ? f.isWrapped(u.container) || f.isNode(u.container) ? (u.container = u.container[0] || u.container, M = (x = u.container["scroll" + A]) + d(o).position()[A.toLowerCase()] + _) : u.container = null : (x = v.State.scrollAnchor[v.State["scrollProperty" + A]], k = v.State.scrollAnchor[v.State["scrollProperty" + ("Left" === A ? "Top" : "Left")]], M = d(o).offset()[A.toLowerCase()] + _), c = { scroll: { rootPropertyValue: !1, startValue: x, currentValue: x, endValue: M, unitType: "", easing: u.easing, scrollData: { container: u.container, direction: A, alternateValue: k } }, element: o }, v.debug && console.log("tweensContainer (scroll): ", c.scroll, o);
            } else if ("reverse" === P) {
              if (!r(o).tweensContainer) return void d.dequeue(o, u.queue);"none" === r(o).opts.display && (r(o).opts.display = "auto"), "hidden" === r(o).opts.visibility && (r(o).opts.visibility = "visible"), r(o).opts.loop = !1, r(o).opts.begin = null, r(o).opts.complete = null, w.easing || delete u.easing, w.duration || delete u.duration, u = d.extend({}, r(o).opts, u);var I = d.extend(!0, {}, r(o).tweensContainer);for (var D in I) {
                if ("element" !== D) {
                  var F = I[D].startValue;I[D].startValue = I[D].currentValue = I[D].endValue, I[D].endValue = F, f.isEmptyObject(w) || (I[D].easing = u.easing), v.debug && console.log("reverse tweensContainer (" + D + "): " + JSON.stringify(I[D]), o);
                }
              }c = I;
            } else if ("start" === P) {
              for (var O in r(o).tweensContainer && !0 === r(o).isAnimating && (I = r(o).tweensContainer), d.each(b, function (t, e) {
                ...
                var V = h(b[O]),
                    z = V[0],
                    N = V[1],
                    E = V[2];O = y.Names.camelCase(O);var W = y.Hooks.getRoot(O),
                    B = !1;if (r(o).isSVG || "tween" === W || !1 !== y.Names.prefixCheck(W)[1] || y.Normalizations.registered[W] !== n) {
                  (u.display !== n && null !== u.display && "none" !== u.display || u.visibility !== n && "hidden" !== u.visibility) && /opacity|filter/.test(O) && !E && 0 !== z && (E = 0), u._cacheValues && I && I[O] ? (E === n && (E = I[O].endValue + I[O].unitType), B = r(o).rootPropertyValueCache[W]) : y.Hooks.registered[O] ? E === n ? (B = y.getPropertyValue(o, W), E = y.getPropertyValue(o, O, B)) : B = y.Hooks.templates[W][1] : E === n && (E = y.getPropertyValue(o, O));var H,
                      j,
                      q,
                      Y = !1;if (E = (H = p(O, E))[0], q = H[1], z = (H = p(O, z))[0].replace(/^([+-\/*])=/, function (t, e) {
                    return Y = e, "";
                    ...
                    a = a || g();var U = /margin|padding|left|right|width|text|word|letter/i.test(O) || /X$/.test(O) || "x" === O ? "x" : "y";switch (q) {case "%":
                        E *= "x" === U ? a.percentToPxWidth : a.percentToPxHeight;break;case "px":
                        break;default:
                        E *= a[q + "ToPx"];}switch (j) {case "%":
                        E *= 1 / ("x" === U ? a.percentToPxWidth : a.percentToPxHeight);break;case "px":
                        break;default:
                        E *= 1 / a[j + "ToPx"];}
                  }switch (Y) {case "+":
                      z = E + z;break;case "-":
                      z = E - z;break;case "*":
                      z *= E;break;case "/":
                      z = E / z;}c[O] = { rootPropertyValue: B, startValue: E, currentValue: E, endValue: z, unitType: j, easing: N }, v.debug && console.log("tweensContainer (" + O + "): " + JSON.stringify(c[O]), o);
              ...
              c = {};switch (r(o) === n && v.init(o), parseFloat(u.delay) && !1 !== u.queue && d.queue(o, u.queue, function (t) {
            v.velocityQueueEntryFlag = !0, r(o).delayTimer = { setTimeout: setTimeout(t, parseFloat(u.delay)), next: t };
            ...
            b,
            w,
            k = arguments[0] && (arguments[0].p || d.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || f.isString(arguments[0].properties));if (f.isWrapped(this) ? (c = !1, p = 0, m = this, h = this) : (c = !0, p = 1, m = k ? arguments[0].elements || arguments[0].e : arguments[0]), m = a(m)) {
          k ? (b = arguments[0].properties || arguments[0].p, w = arguments[0].options || arguments[0].o) : (b = arguments[p], w = arguments[p + 1]);var S = m.length,
            ...
            w = {};for (var M = p + 1; M < arguments.length; M++) {
              ...
              T = { promise: null, resolver: null, rejecter: null };switch (c && v.Promise && (T.promise = new v.Promise(function (t, e) {
            T.resolver = t, T.rejecter = e;
              ...
              d.each(m, function (t, e) {
              ...
              });var A = [];return d.each(v.State.calls, function (t, e) {
                e && d.each(e[1], function (i, a) {
                  var o = w === n ? "" : w;return !0 !== o && e[2].queue !== o && (w !== n || !1 !== e[2].queue) || void d.each(m, function (i, n) {
                ...
                u(e, !0);
              }), T.promise && T.resolver(m)), t();default:
              if (!d.isPlainObject(b) || f.isEmptyObject(b)) {
                if (f.isString(b) && v.Redirects[b]) {
                  var _ = (O = d.extend({}, w)).duration,
                      I = O.delay || 0;return !0 === O.backwards && (m = d.extend(!0, [], m).reverse()), d.each(m, function (t, e) {
                ...
                }var D = "Velocity: First argument (" + b + ") was not a property map, a known action, or a registered redirect. Aborting.";return T.promise ? T.rejecter(new Error(D)) : console.log(D), t();
              }P = "start";}var F,
              O,
              ...
              R = [];if (d.each(m, function (t, e) {
            f.isNode(e) && o.call(e);
          }), (O = d.extend({}, v.defaults, w)).loop = parseInt(O.loop), F = 2 * O.loop - 1, O.loop) for (var V = 0; F > V; V++) {
            var z = { delay: O.delay, progress: O.progress };V === F - 1 && (z.display = O.display, z.visibility = O.visibility, z.complete = O.complete), x(m, "reverse", z);
          }return t();
        }
      };(v = d.extend(x, v)).animate = x;var w = e.requestAnimationFrame || h;return v.State.isMobile || i.hidden === n || i.addEventListener("visibilitychange", function () {
        ...
        v.Redirects["slide" + e] = function (t, i, a, r, o, s) {
          var l = d.extend({}, i),
              ...
              f = {};l.display === n && (l.display = "Down" === e ? "inline" === v.CSS.Values.getDisplayType(t) ? "inline-block" : "block" : "none"), l.begin = function () {
            for (var i in u && u.call(o, o), h) {
              f[i] = t.style[i];var n = v.CSS.getPropertyValue(t, i);h[i] = "Down" === e ? [n, 0] : [0, n];
  ...
  return function () {
    return function t(e, i, n) {
    ...
    }, { 10: 10, 11: 11, 12: 12, 13: 13, 14: 14, 15: 15, 16: 16, 17: 17, 18: 18, 19: 19, 20: 20, 21: 21, 22: 22, 23: 23, 24: 24, 25: 25, 26: 26, 27: 27, 28: 28, 29: 29, 30: 30, 31: 31, 32: 32, 33: 33, 34: 34, 35: 35, 36: 36, 41: 41, 46: 46, 49: 49, 50: 50, 54: 54, 55: 55, 56: 56, 57: 57, 58: 58, 59: 59, 8: 8, 9: 9 }], 8: [function (t, e, i) {
      "use strict";
      ...
      var n = t(26),
          a = t(41),
          r = t(46);n._set("bubble", { hover: { mode: "single" }, scales: { xAxes: [{ type: "linear", position: "bottom", id: "x-axis-0" }], yAxes: [{ type: "linear", position: "left", id: "y-axis-0" }] }, tooltips: { callbacks: { title: function title() {
              return "";
            }, label: function label(t, e) {
        ...
        t.controllers.bubble = t.DatasetController.extend({ dataElementType: a.Point, update: function update(t) {
            ...
            var n = this,
                ...
                h = i ? s.getBasePixel() : s.getPixelForValue(u, e, d);t._xScale = o, t._yScale = s, t._options = l, t._datasetIndex = d, t._index = e, t._model = { backgroundColor: l.backgroundColor, borderColor: l.borderColor, borderWidth: l.borderWidth, hitRadius: l.hitRadius, pointStyle: l.pointStyle, rotation: l.rotation, radius: i ? 0 : l.radius, skip: r.skip || isNaN(c) || isNaN(h), x: c, y: h }, t.pivot();
          }, setHoverStyle: function setHoverStyle(t) {
            var e = t._model,
                i = t._options;t.$previousStyle = { backgroundColor: e.backgroundColor, borderColor: e.borderColor, borderWidth: e.borderWidth, radius: e.radius }, e.backgroundColor = r.valueOrDefault(i.hoverBackgroundColor, r.getHoverColor(i.backgroundColor)), e.borderColor = r.valueOrDefault(i.hoverBorderColor, r.getHoverColor(i.borderColor)), e.borderWidth = r.valueOrDefault(i.hoverBorderWidth, i.borderWidth), e.radius = i.radius + i.hoverRadius;
            ...
            var i,
                ...
                p = ["backgroundColor", "borderColor", "borderWidth", "hoverBackgroundColor", "hoverBorderColor", "hoverBorderWidth", "hoverRadius", "hitRadius", "pointStyle", "rotation"];for (i = 0, n = p.length; i < n; ++i) {
      ...
      var n = t(26),
          a = t(41),
          r = t(46);n._set("doughnut", { animation: { animateRotate: !0, animateScale: !1 }, hover: { mode: "single" }, legendCallback: function legendCallback(t) {
        ...
        t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({ dataElementType: a.Arc, linkScales: r.noop, getRingIndex: function getRingIndex(t) {
            ...
            var n = this,
                ...
                v = r.valueAtIndexOrDefault;r.extend(t, { _datasetIndex: n.index, _index: e, _model: { x: u + a.offsetX, y: d + a.offsetY, startAngle: c, endAngle: h, circumference: p, outerRadius: m, innerRadius: g, label: v(f.label, e, a.data.labels[e]) } });var b = t._model,
                y = t.custom || {},
      ...
      var n = t(26),
          a = t(41),
          r = t(46);n._set("line", { showLines: !0, spanGaps: !1, hover: { mode: "label" }, scales: { xAxes: [{ type: "category", id: "x-axis-0" }], yAxes: [{ type: "linear", id: "y-axis-0" }] } }), e.exports = function (t) {
        function e(t, e) {
          return r.valueOrDefault(t.showLine, e.showLines);
            ...
            var i = this.chart.options.elements.point.rotation,
                n = this.getDataset(),
                a = t.custom || {};return isNaN(a.rotation) ? isNaN(n.pointRotation) && !r.isArray(n.pointRotation) || (i = r.valueAtIndexOrDefault(n.pointRotation, e, i)) : i = a.rotation, i;
          }, updateElement: function updateElement(t, e, i) {
            var n,
                a,
                o = this,
            ...
            var t,
                ...
                o = i.chartArea,
                s = a.length,
                l = 0;for (e(this.getDataset(), i.options) && (t = (n.dataset._model.borderWidth || 0) / 2, r.canvas.clipArea(i.ctx, { left: o.left, right: o.right, top: o.top - t, bottom: o.bottom + t }), n.dataset.draw(), r.canvas.unclipArea(i.ctx)); l < s; ++l) {
              a[l].draw(o);
            }
          }, setHoverStyle: function setHoverStyle(t) {
            var e = this.chart.data.datasets[t._datasetIndex],
                i = t._index,
                n = t.custom || {},
                a = t._model;t.$previousStyle = { backgroundColor: a.backgroundColor, borderColor: a.borderColor, borderWidth: a.borderWidth, radius: a.radius }, a.backgroundColor = n.hoverBackgroundColor || r.valueAtIndexOrDefault(e.pointHoverBackgroundColor, i, r.getHoverColor(a.backgroundColor)), a.borderColor = n.hoverBorderColor || r.valueAtIndexOrDefault(e.pointHoverBorderColor, i, r.getHoverColor(a.borderColor)), a.borderWidth = n.hoverBorderWidth || r.valueAtIndexOrDefault(e.pointHoverBorderWidth, i, a.borderWidth), a.radius = n.hoverRadius || r.valueAtIndexOrDefault(e.pointHoverRadius, i, this.chart.options.elements.point.hoverRadius);
          } });
      };
      ...
      var n = t(26),
          a = t(41),
          r = t(46);n._set("polarArea", { scale: { type: "radialLinear", angleLines: { display: !1 }, gridLines: { circular: !0 }, pointLabels: { display: !1 }, ticks: { beginAtZero: !0 } }, animation: { animateRotate: !0, animateScale: !0 }, startAngle: -.5 * Math.PI, legendCallback: function legendCallback(t) {
          var e = [];e.push('<ul class="' + t.id + '-legend">');var i = t.data,
              n = i.datasets,
              a = i.labels;if (n.length) for (var r = 0; r < n[0].data.length; ++r) {
            e.push('<li><span style="background-color:' + n[0].backgroundColor[r] + '"></span>'), a[r] && e.push(a[r]), e.push("</li>");
        ...
        t.controllers.polarArea = t.DatasetController.extend({ dataElementType: a.Arc, linkScales: r.noop, update: function update(t) {
            var e,
                ...
                u = a._starts = [],
                d = a._angles = [];for (a._updateRadius(), s.count = a.countVisibleElements(), e = 0, i = o.data.length; e < i; e++) {
            ...
            var t = this,
                ...
                n = e.options,
                a = n.elements.arc,
                r = Math.min(i.right - i.left, i.bottom - i.top);e.outerRadius = Math.max((r - a.borderWidth / 2) / 2, 0), e.innerRadius = Math.max(n.cutoutPercentage ? e.outerRadius / 100 * n.cutoutPercentage : 1, 0), e.radiusLength = (e.outerRadius - e.innerRadius) / e.getVisibleDatasetCount(), t.outerRadius = e.outerRadius - e.radiusLength * t.index, t.innerRadius = t.outerRadius - e.radiusLength;
          }, updateElement: function updateElement(t, e, i) {
            var n = this,
                a = n.chart,
                o = n.getDataset(),
                ...
                v = l.animateScale ? 0 : u.getDistanceFromCenterForValue(o.data[e]);r.extend(t, { _datasetIndex: n.index, _index: e, _scale: u, _model: { x: c, y: h, innerRadius: 0, outerRadius: i ? v : p, startAngle: i && l.animateRotate ? f : g, endAngle: i && l.animateRotate ? f : m, label: r.valueAtIndexOrDefault(d, e, d[e]) } });var b = this.chart.options.elements.arc,
                y = t.custom || {},
                x = r.valueAtIndexOrDefault,
                w = t._model;w.backgroundColor = y.backgroundColor ? y.backgroundColor : x(o.backgroundColor, e, b.backgroundColor), w.borderColor = y.borderColor ? y.borderColor : x(o.borderColor, e, b.borderColor), w.borderWidth = y.borderWidth ? y.borderWidth : x(o.borderWidth, e, b.borderWidth), t.pivot();
            ...
            var e = this,
                ...
                n = e.getDataset(),
                a = e.getMeta();if (isNaN(n.data[t]) || a.data[t].hidden) return 0;var o = { chart: e.chart, dataIndex: t, dataset: n, datasetIndex: e.index };return r.options.resolve([e.chart.options.elements.arc.angle, 2 * Math.PI / i], o, t);
          } });
      };
      ...
      var n = t(26),
          a = t(41),
          r = t(46);n._set("radar", { scale: { type: "radialLinear" }, elements: { line: { tension: 0 } } }), e.exports = function (t) {
        t.controllers.radar = t.DatasetController.extend({ datasetElementType: a.Line, dataElementType: a.Point, linkScales: r.noop, update: function update(t) {
            ...
            var e = this.chart.data.datasets[t._datasetIndex],
                i = t.custom || {},
                n = t._index,
                a = t._model;t.$previousStyle = { backgroundColor: a.backgroundColor, borderColor: a.borderColor, borderWidth: a.borderWidth, radius: a.radius }, a.radius = i.hoverRadius ? i.hoverRadius : r.valueAtIndexOrDefault(e.pointHoverRadius, n, this.chart.options.elements.point.hoverRadius), a.backgroundColor = i.hoverBackgroundColor ? i.hoverBackgroundColor : r.valueAtIndexOrDefault(e.pointHoverBackgroundColor, n, r.getHoverColor(a.backgroundColor)), a.borderColor = i.hoverBorderColor ? i.hoverBorderColor : r.valueAtIndexOrDefault(e.pointHoverBorderColor, n, r.getHoverColor(a.borderColor)), a.borderWidth = i.hoverBorderWidth ? i.hoverBorderWidth : r.valueAtIndexOrDefault(e.pointHoverBorderWidth, n, a.borderWidth);
          } });
      };
    }, { 26: 26, 41: 41, 46: 46 }], 21: [function (t, e, i) {
      "use strict";
      t(26)._set("scatter", { hover: { mode: "single" }, scales: { xAxes: [{ id: "x-axis-1", type: "linear", position: "bottom" }], yAxes: [{ id: "y-axis-1", type: "linear", position: "left" }] }, showLines: !1, tooltips: { callbacks: { title: function title() {
              return "";
      ...
      "use strict";
      var n = t(27);i = e.exports = n.extend({ chart: null, currentStep: 0, numSteps: 60, easing: "", render: null, onAnimationProgress: null, onAnimationComplete: null });Object.defineProperty(i.prototype, "animationObject", { get: function get() {
          return this;
        } }), Object.defineProperty(i.prototype, "chartInstance", { get: function get() {
          return this.chart;
        }, set: function set(t) {
          this.chart = t;
        } });
      ...
      "use strict";
      var n = t(26),
          a = t(46);n._set("global", { animation: { duration: 1e3, easing: "easeOutQuart", onProgress: a.noop, onComplete: a.noop } }), e.exports = { frameDuration: 17, animations: [], dropFrames: 0, request: null, addAnimation: function addAnimation(t, e, i, n) {
          var a,
              r,
          ...
          var t = this;null === t.request && (t.request = a.requestAnimFrame.call(window, function () {
      ...
      var n = t(22),
          ...
          d = t(32),
          c = t(34),
          h = t(36);e.exports = function (t) {
        function e(t) {
          return "top" === t || "bottom" === t;
        }t.types = {}, t.instances = {}, t.controllers = {}, o.extend(t.prototype, { construct: function construct(e, i) {
            var n = this;i = function (t) {
              var e = (t = t || {}).data = t.data || {};return e.datasets = e.datasets || [], e.labels = e.labels || [], t.options = o.configMerge(r.global, r[t.type], t.options || {}), t;
            }(i);var a = u.acquireContext(e, i),
                s = a && a.canvas,
                l = s && s.height,
                d = s && s.width;n.id = o.uid(), n.ctx = a, n.canvas = s, n.config = i, n.width = d, n.height = l, n.aspectRatio = l ? d / l : null, n.options = i.options, n._bufferedRender = !1, n.chart = n, n.controller = n, t.instances[n.id] = n, Object.defineProperty(n, "data", { get: function get() {
                return n.config.data;
              }, set: function set(t) {
                n.config.data = t;
              } }), a && s ? (n.initialize(), n.update()) : console.error("Failed to create chart: can't acquire context from the given item");
          }, initialize: function initialize() {
            var t = this;return d.notify(t, "beforeInit"), o.retinaScale(t, t.options.devicePixelRatio), t.bindEvents(), t.options.responsive && t.resize(!0), t.ensureScalesHaveIDs(), t.buildOrUpdateScales(), t.initToolTip(), d.notify(t, "afterInit"), t;
            ...
            var e = this,
                ...
                s = Math.max(0, Math.floor(a ? r / a : o.getMaximumHeight(n)));if ((e.width !== r || e.height !== s) && (n.width = e.width = r, n.height = e.height = s, n.style.width = r + "px", n.style.height = s + "px", o.retinaScale(e, i.devicePixelRatio), !t)) {
              var l = { width: r, height: s };d.notify(e, "resize", [l]), e.options.onResize && e.options.onResize(e, l), e.stop(), e.update({ duration: e.options.responsiveAnimationDuration });
            }
          }, ensureScalesHaveIDs: function ensureScalesHaveIDs() {
            var t = this.options,
                e = t.scales || {},
                i = t.scale;o.each(e.xAxes, function (t, e) {
              t.id = t.id || "x-axis-" + e;
            ...
            }))), i.scale && a.push({ options: i.scale, dtype: "radialLinear", isDefault: !0, dposition: "chartArea" }), o.each(a, function (i) {
              var a = i.options,
                  s = a.id,
                  l = o.valueOrDefault(a.type, i.dtype);e(a.position) !== e(i.dposition) && (a.position = i.dposition), r[s] = !0;var u = null;if (s in n && n[s].type === l) (u = n[s]).options = a, u.ctx = t.ctx, u.chart = t;else {
                var d = c.getScaleConstructor(l);if (!d) return;u = new d({ id: s, type: l, options: a, ctx: t.ctx, chart: t }), n[u.id] = u;
            ...
            var e = this,
                i = [],
                n = [];return o.each(e.data.datasets, function (a, r) {
            ...
            var t = this;o.each(t.data.datasets, function (e, i) {
            ...
            var i,
                n,
                a = this;if (e && "object" == (typeof e === "undefined" ? "undefined" : _typeof(e)) || (e = { duration: e, lazy: arguments[1] }), n = (i = a).options, o.each(i.scales, function (t) {
              l.removeBox(i, t);
              ...
              a.tooltip._data = a.data;var r = a.buildOrUpdateControllers();o.each(a.data.datasets, function (t, e) {
                ...
                t.reset();
              }), a.updateDatasets(), a.tooltip.initialize(), a.lastActive = [], d.notify(a, "afterUpdate"), a._bufferedRender ? a._bufferedRequest = { duration: e.duration, easing: e.easing, lazy: e.lazy } : a.render(e);
            }
            ...
            var e = this.getDatasetMeta(t),
                i = { meta: e, index: t };!1 !== d.notify(this, "beforeDatasetUpdate", [i]) && (e.controller.update(), d.notify(this, "afterDatasetUpdate", [i]));
          }, render: function render(t) {
            var e = this;t && "object" == (typeof t === "undefined" ? "undefined" : _typeof(t)) || (t = { duration: t, lazy: arguments[1] });var i = t.duration,
                r = t.lazy;if (!1 !== d.notify(e, "beforeRender")) {
              var s = e.options.animation,
                  l = function l(t) {
                d.notify(e, "afterRender"), o.callback(s && s.onComplete, [t], e);
              };if (s && (void 0 !== i && 0 !== i || void 0 === i && 0 !== s.duration)) {
                var u = new n({ numSteps: (i || s.duration) / 16.66, easing: t.easing || s.easing, render: function render(t, e) {
                    var i = o.easing.effects[e.easing],
                        n = e.currentStep,
                        a = n / e.numSteps;t.draw(i(a), a, n);
                  }, onAnimationProgress: s.onProgress, onAnimationComplete: l });a.addAnimation(e, u, i, r);
              } else e.draw(), l(new n({ numSteps: 0, chart: e }));return e;
            }
          }, draw: function draw(t) {
            var e = this;e.clear(), o.isNullOrUndef(t) && (t = 1), e.transition(t), e.width <= 0 || e.height <= 0 || !1 !== d.notify(e, "beforeDraw", [t]) && (o.each(e.boxes, function (t) {
              t.draw(e.chartArea);
            ...
            var e = this;if (!1 !== d.notify(e, "beforeDatasetsDraw", [t])) {
            ...
            var i = this.getDatasetMeta(t),
                n = { meta: i, index: t, easingValue: e };!1 !== d.notify(this, "beforeDatasetDraw", [n]) && (i.controller.draw(e), d.notify(this, "afterDatasetDraw", [n]));
          }, _drawTooltip: function _drawTooltip(t) {
            var e = this.tooltip,
                i = { tooltip: e, easingValue: t };!1 !== d.notify(this, "beforeTooltipDraw", [i]) && (e.draw(), d.notify(this, "afterTooltipDraw", [i]));
            ...
            var n = s.modes[e];return "function" == typeof n ? n(this, t, i) : [];
            ...
            var e,
                i,
                n = this,
                a = n.canvas;for (n.stop(), e = 0, i = n.data.datasets.length; e < i; ++e) {
            ...
            var t = this;t.tooltip = new h({ _chart: t, _chartInstance: t, _data: t.data, _options: t.options.tooltips }, t);
            ...
            var t = this,
                e = t._listeners;e && (delete t._listeners, o.each(e, function (e, i) {
            ...
            var e = this,
                i = e.tooltip;if (!1 !== d.notify(e, "beforeEvent", [t])) {
      ...
      "use strict";
      var n = t(46);e.exports = function (t) {
      ...
      "use strict";
      var n = t(46);e.exports = { _set: function _set(t, e) {
          return n.merge(this[t] || (this[t] = {}), e);
        } };
    }, { 46: 46 }], 27: [function (t, e, i) {
      "use strict";
      var n = t(3),
          a = t(46);var r = function r(t) {
      ...
      var n = t(3),
        ...
        function t(t, e, i) {
          ...
          var o = document.defaultView,
              ...
              d = e(l),
              c = e(u),
              h = Number.POSITIVE_INFINITY;return d || c ? Math.min(d ? t(l, i, a) : h, c ? t(u, s, a) : h) : "none";
        }r.configMerge = function () {
          return r.merge(r.clone(arguments[0]), [].slice.call(arguments, 1), { merger: function merger(t, e, i, n) {
              var a = e[t] || {},
                  s = i[t];"scales" === t ? e[t] = r.scaleMerge(a, s) : "scale" === t ? e[t] = r.merge(a, [o.getScaleDefaults(s.type), s]) : r._merger(t, e, i, n);
            } });
          ...
          return r.merge(r.clone(arguments[0]), [].slice.call(arguments, 1), { merger: function merger(t, e, i, n) {
              if ("xAxes" === t || "yAxes" === t) {
                var a,
                    s,
                    l,
                    u = i[t].length;for (e[t] || (e[t] = []), a = 0; a < u; ++a) {
          ...
          var e = t.parentNode;return e && e.host && (e = e.host), e;
        }, r.getMaximumWidth = function (t) {
          var e = r._getParentNode(t);if (!e) return t.clientWidth;var i = e.clientWidth,
              n = i - r._calculatePadding(e, "padding-left", i) - r._calculatePadding(e, "padding-right", i),
              a = r.getConstraintWidth(t);return isNaN(a) ? n : Math.min(n, a);
        }, r.getMaximumHeight = function (t) {
          var e = r._getParentNode(t);if (!e) return t.clientHeight;var i = e.clientHeight,
              n = i - r._calculatePadding(e, "padding-top", i) - r._calculatePadding(e, "padding-bottom", i),
              a = r.getConstraintHeight(t);return isNaN(a) ? n : Math.min(n, a);
        }, r.getStyle = function (t, e) {
          return t.currentStyle ? t.currentStyle[e] : document.defaultView.getComputedStyle(t, null).getPropertyValue(e);
        }, r.retinaScale = function (t, e) {
          var i = t.currentDevicePixelRatio = e || "undefined" != typeof window && window.devicePixelRatio || 1;if (1 !== i) {
            var n = t.canvas,
                a = t.height,
        ...
        t.forEach(function (t, e) {
          ...
          if (t) {
            var o = t.options.layout || {},
                ...
                p = a(t.boxes, "top"),
                g = a(t.boxes, "bottom"),
                m = a(t.boxes, "chartArea");r(h, !0), r(f, !1), r(p, !0), r(g, !1);var v = e - l - u,
                b = i - d - c,
                y = b / 2,
              ...
              var e,
                  i = t.isHorizontal();i ? (e = t.update(t.fullWidth ? v : k, w), S -= e.height) : (e = t.update(x, S), k -= e.width), C.push({ horizontal: i, minSize: e, box: t });
            });var M = 0,
                P = 0,
                T = 0,
                A = 0;n.each(p.concat(g), function (t) {
              if (t.getPadding) {
              ...
              if (t.getPadding) {
                ...
                I = u,
                D = d,
                F = c;n.each(h.concat(f), E), n.each(h, function (t) {
              _ += t.width;
            }), n.each(f, function (t) {
              I += t.width;
              ...
              F += t.height;
            });var O = Math.max(M - _, 0);_ += O, I += Math.max(P - I, 0);var L = Math.max(T - D, 0);D += L, F += Math.max(A - F, 0);var R = i - D - F,
                V = e - _ - I;V === k && R === S || (n.each(h, function (t) {
              t.height = R;
            }), n.each(f, function (t) {
              t.height = R;
            }), n.each(p, function (t) {
              ...
              t.fullWidth || (t.width = V);
                ...
                N = d + L;n.each(h.concat(p), W), z += k, N += S, n.each(f, W), n.each(g, W), t.chartArea = { left: _, top: D, right: _ + k, bottom: D + S }, n.each(m, function (e) {
            ...
            var e = n.findNextWhere(C, function (e) {
              ...
              var i = { left: Math.max(_, M), right: Math.max(I, P), top: 0, bottom: 0 };t.update(t.fullWidth ? v : k, b / 2, i);
      ...
      "use strict";
      var n = t(26),
          a = t(46);n._set("global", { plugins: {} }), e.exports = { _plugins: [], _cacheId: 0, register: function register(t) {
      ...
      var n = t(26),
        ...
        return r.options.toLineHeight(r.valueOrDefault(t.lineHeight, 1.2), r.valueOrDefault(t.fontSize, n.global.defaultFontSize));
      }n._set("scale", { display: !0, position: "left", offset: !1, gridLines: { display: !0, color: "rgba(0, 0, 0, 0.1)", lineWidth: 1, drawBorder: !0, drawOnChartArea: !0, drawTicks: !0, tickMarkLength: 10, zeroLineWidth: 1, zeroLineColor: "rgba(0,0,0,0.25)", zeroLineBorderDash: [], zeroLineBorderDashOffset: 0, offsetGridLines: !1, borderDash: [], borderDashOffset: 0 }, scaleLabel: { display: !1, labelString: "", lineHeight: 1.2, padding: { top: 4, bottom: 4 } }, ticks: { beginAtZero: !1, minRotation: 0, maxRotation: 50, mirror: !1, padding: 0, reverse: !1, display: !0, autoSkip: !0, autoSkipPadding: 0, labelOffset: 0, callback: o.formatters.values, minor: {}, major: {} } }), e.exports = a.extend({ getPadding: function getPadding() {
          ...
          var t = this,
              ...
              i = t.options.ticks,
              n = s(t._ticks),
              a = d(i);e.font = a.font;var o = i.minRotation || 0;if (n.length && t.options.display && t.isHorizontal()) for (var l, u = r.longestText(e, a.font, n, t.longestTextCache), c = u, h = t.getPixelForTick(1) - t.getPixelForTick(0) - 6; c > h && o < i.maxRotation;) {
            var f = r.toRadians(o);if (l = Math.cos(f), Math.sin(f) * u > t.maxHeight) {
              o--;break;
            }o++, c = l * u;
          }t.labelRotation = o;
          ...
          var t = this,
              ...
              f = t.isHorizontal(),
              p = d(a),
              g = n.gridLines.tickMarkLength;if (e.width = f ? t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth : h && l.drawTicks ? g : 0, e.height = f ? h && l.drawTicks ? g : 0 : t.maxHeight, o.display && h) {
            var m = c(o) + r.options.toPadding(o.padding).height;f ? e.height += m : e.width += m;
          }if (a.display && h) {
            var v = r.longestText(t.ctx, p.font, i, t.longestTextCache),
                b = r.numberOfLabelLines(i),
                y = .5 * p.size,
                x = t.options.ticks.padding;if (f) {
              t.longestLabelWidth = v;var w = r.toRadians(t.labelRotation),
                  k = Math.cos(w),
                  S = Math.sin(w) * v + p.size * b + y * (b - 1) + y;e.height = Math.min(t.maxHeight, e.height + S + x), t.ctx.font = p.font;var C = u(t.ctx, i[0], p.font),
                  M = u(t.ctx, i[i.length - 1], p.font);0 !== t.labelRotation ? (t.paddingLeft = "bottom" === n.position ? k * C + 3 : k * y + 3, t.paddingRight = "bottom" === n.position ? k * y + 3 : k * M + 3) : (t.paddingLeft = C / 2 + 3, t.paddingRight = M / 2 + 3);
          ...
          var e = this,
            ...
            var a = e.ctx,
                ...
                D = "bottom" === i.position ? e.top + T + w : e.bottom + T;if (r.each(m, function (n, a) {
              if (!r.isNullOrUndef(n.label)) {
                var u,
                    ...
                    O,
                    L,
                    R = n.label;a === e.zeroLineIndex && i.offset === h.offsetGridLines ? (u = h.zeroLineWidth, d = h.zeroLineColor, c = h.zeroLineBorderDash, f = h.zeroLineBorderDashOffset) : (u = r.valueAtIndexOrDefault(h.lineWidth, a), d = r.valueAtIndexOrDefault(h.color, a), c = r.valueOrDefault(h.borderDash, o.borderDash), f = r.valueOrDefault(h.borderDashOffset, o.borderDashOffset));var V = "middle",
                    z = "middle",
                    N = s.padding;if (g) {
                  var E = w + N;"bottom" === i.position ? (z = p ? "middle" : "top", V = p ? "right" : "center", L = e.top + E) : (z = p ? "middle" : "bottom", V = p ? "left" : "center", L = e.bottom - E);var W = l(e, a, h.offsetGridLines && m.length > 1);W < e.left && (d = "rgba(0,0,0,0)"), W += r.aliasPixel(u), O = e.getPixelForTick(a) + s.labelOffset, v = y = k = C = W, b = I, x = D, S = t.top, F = t.bottom + T;
                } else {
                  var B,
                      H = "left" === i.position;s.mirror ? (V = H ? "left" : "right", B = N) : (V = H ? "right" : "left", B = w + N), O = H ? e.right - B : e.left + B;var j = l(e, a, h.offsetGridLines && m.length > 1);j < e.top && (d = "rgba(0,0,0,0)"), j += r.aliasPixel(u), L = e.getPixelForTick(a) + s.labelOffset, v = A, y = _, k = t.left, C = t.right + T, b = x = S = F = j;
              ...
              if (h.display && (a.save(), a.lineWidth = t.glWidth, a.strokeStyle = t.glColor, a.setLineDash && (a.setLineDash(t.glBorderDash), a.lineDashOffset = t.glBorderDashOffset), a.beginPath(), h.drawTicks && (a.moveTo(t.tx1, t.ty1), a.lineTo(t.tx2, t.ty2)), h.drawOnChartArea && (a.moveTo(t.x1, t.y1), a.lineTo(t.x2, t.y2)), a.stroke(), a.restore()), s.display) {
                a.save(), a.translate(t.labelX, t.labelY), a.rotate(t.rotation), a.font = t.major ? x.font : b.font, a.fillStyle = t.major ? y : v, a.textBaseline = t.textBaseline, a.textAlign = t.textAlign;var i = t.label;if (r.isArray(i)) for (var n = i.length, o = 1.5 * b.size, l = e.isHorizontal() ? 0 : -o * (n - 1) / 2, u = 0; u < n; ++u) {
                  a.fillText("" + i[u], 0, l), l += o;
                } else a.fillText(i, 0, 0);a.restore();
              }
            }), f.display) {
              var F,
                  O,
                  L = 0,
                  R = c(f) / 2;if (g) F = e.left + (e.right - e.left) / 2, O = "bottom" === i.position ? e.bottom - R - C.bottom : e.top + R + C.top;else {
                var V = "left" === i.position;F = V ? e.left + R + C.top : e.right - R - C.top, O = e.top + (e.bottom - e.top) / 2, L = V ? -.5 * Math.PI : .5 * Math.PI;
              ...
              a.lineWidth = r.valueAtIndexOrDefault(h.lineWidth, 0), a.strokeStyle = r.valueAtIndexOrDefault(h.color, 0);var z = e.left,
                  N = e.right + T,
                  E = e.top,
                  W = e.bottom + T,
                  B = r.aliasPixel(a.lineWidth);g ? (E = W = "top" === i.position ? e.bottom : e.top, E += B, W += B) : (z = N = "left" === i.position ? e.right : e.left, z += B, N += B), a.beginPath(), a.moveTo(z, E), a.lineTo(N, W), a.stroke();
            }
          }
        } });
      ...
      var n = t(26),
          a = t(46),
          r = t(31);e.exports = { constructors: {}, defaults: {}, registerScaleType: function registerScaleType(t, e, i) {
      ...
      "use strict";
      var n = t(46);e.exports = { formatters: { values: function values(t) {
            ...
            var a = i.length > 3 ? i[2] - i[1] : i[1] - i[0];Math.abs(a) > 1 && t !== Math.floor(t) && (a = t - Math.floor(t));var r = n.log10(Math.abs(a)),
              ...
              if (Math.max(Math.abs(i[0]), Math.abs(i[i.length - 1])) < 1e-4) {
                var s = n.log10(Math.abs(t));o = t.toExponential(Math.floor(s) - Math.floor(r));
              } else {
                var l = -1 * Math.floor(r);l = Math.max(Math.min(l, 20), 0), o = t.toFixed(l);
              }
            } else o = "0";return o;
      ...
      var n = t(26),
          ...
          r = t(46);n._set("global", { tooltips: { enabled: !0, custom: null, mode: "nearest", position: "average", intersect: !0, backgroundColor: "rgba(0,0,0,0.8)", titleFontStyle: "bold", titleSpacing: 2, titleMarginBottom: 6, titleFontColor: "#fff", titleAlign: "left", bodySpacing: 2, bodyFontColor: "#fff", bodyAlign: "left", footerFontStyle: "bold", footerSpacing: 2, footerMarginTop: 6, footerFontColor: "#fff", footerAlign: "left", yPadding: 6, xPadding: 6, caretPadding: 2, caretSize: 5, cornerRadius: 6, multiKeyBackground: "#fff", displayColors: !0, borderColor: "rgba(0,0,0,0)", borderWidth: 0, callbacks: { beforeTitle: r.noop, title: function title(t, e) {
            ...
            }, afterLabel: r.noop, afterBody: r.noop, beforeFooter: r.noop, footer: r.noop, afterFooter: r.noop } } });var o = { average: function average(t) {
        ...
        return l([], u(t));
      }(e.exports = a.extend({ initialize: function initialize() {
          ...
          var t = this._options.callbacks,
              ...
              a = [];return a = l(a = l(a = l(a, u(e)), u(i)), u(n));
        }, getBeforeBody: function getBeforeBody() {
          return c(this._options.callbacks.beforeBody.apply(this, arguments));
        }, getBody: function getBody(t, e) {
          var i = this,
              n = i._options.callbacks,
              a = [];return r.each(t, function (t) {
            var r = { before: [], lines: [], after: [] };l(r.before, u(n.beforeLabel.call(i, t, e))), l(r.lines, n.label.call(i, t, e)), l(r.after, u(n.afterLabel.call(i, t, e))), a.push(r);
          }), a;
          ...
          var e,
            ...
            p.opacity = 1;var w = [],
                k = [];x = o[h.position].call(c, g, c._eventPosition);var S = [];for (e = 0, i = g.length; e < i; ++e) {
              S.push((n = g[e], a = void 0, s = void 0, void 0, void 0, a = n._xScale, s = n._yScale || n._scale, l = n._index, u = n._datasetIndex, { xLabel: a ? a.getLabelForIndex(l, u) : "", yLabel: s ? s.getLabelForIndex(l, u) : "", index: l, datasetIndex: u, x: n._model.x, y: n._model.y }));
          ...
          } else p.opacity = 0;return p.xAlign = v.xAlign, p.yAlign = v.yAlign, p.x = b.x, p.y = b.y, p.width = y.width, p.height = y.height, p.caretX = x.x, p.caretY = x.y, c._model = p, t && h.custom && h.custom.call(c, p), c;
          ...
          var n,
              ...
              p = t.y,
              g = e.width,
              m = e.height;if ("center" === h) s = p + m / 2, "left" === c ? (a = (n = f) - u, r = n, o = s + u, l = s - u) : (a = (n = f + g) + u, r = n, o = s - u, l = s + u);else if ("left" === c ? (n = (a = f + d + u) - u, r = a + u) : "right" === c ? (n = (a = f + g - d - u) - u, r = a + u) : (n = (a = i.caretX) - u, r = a + u), "top" === h) s = (o = p) - u, l = o;else {
            s = (o = p + m) + u, l = o;var v = r;r = n, n = v;
          }return { x1: n, x2: a, x3: r, y1: o, y2: s, y3: l };
        }, drawTitle: function drawTitle(t, e, i, n) {
          var a = e.title;if (a.length) {
            i.textAlign = e._titleAlign, i.textBaseline = "top";var o,
                l,
                u = e.titleFontSize,
                d = e.titleSpacing;for (i.fillStyle = s(e.titleFontColor, n), i.font = r.fontString(u, e._titleFontStyle, e._titleFontFamily), o = 0, l = a.length; o < l; ++o) {
              i.fillText(a[o], t.x, t.y), t.y += u + d, o + 1 === a.length && (t.y += e.titleMarginBottom - d);
            }
          }
        }, drawBody: function drawBody(t, e, i, n) {
          var a = e.bodyFontSize,
              o = e.bodySpacing,
              l = e.body;i.textAlign = e._bodyAlign, i.textBaseline = "top", i.font = r.fontString(a, e._bodyFontStyle, e._bodyFontFamily);var u = 0,
              d = function d(e) {
            i.fillText(e, t.x + u, t.y), t.y += a + o;
          };i.fillStyle = s(e.bodyFontColor, n), r.each(e.beforeBody, d);var c = e.displayColors;u = c ? a + 2 : 0, r.each(l, function (o, l) {
            var u = s(e.labelTextColors[l], n);i.fillStyle = u, r.each(o.before, d), r.each(o.lines, function (r) {
        ...
        }, drawFooter: function drawFooter(t, e, i, n) {
          var a = e.footer;a.length && (t.y += e.footerMarginTop, i.textAlign = e._footerAlign, i.textBaseline = "top", i.fillStyle = s(e.footerFontColor, n), i.font = r.fontString(e.footerFontSize, e._footerFontStyle, e._footerFontFamily), r.each(a, function (n) {
            i.fillText(n, t.x, t.y), t.y += e.footerFontSize + e.footerSpacing;
          }));
        }, drawBackground: function drawBackground(t, e, i, n, a) {
          i.fillStyle = s(e.backgroundColor, a), i.strokeStyle = s(e.borderColor, a), i.lineWidth = e.borderWidth;var r = e.xAlign,
              o = e.yAlign,
              l = t.x,
              u = t.y,
              d = n.width,
      ...
      var n = t(26),
          a = t(27),
          r = t(46);n._set("global", { elements: { arc: { backgroundColor: n.global.defaultColor, borderColor: "#fff", borderWidth: 2 } } }), e.exports = a.extend({ inLabelRange: function inLabelRange(t) {
      ...
      var n = t(26),
        ...
        var e = this._view;return !!e && Math.abs(t - e.x) < e.radius + e.hitRadius;
          ...
          var e = this._view,
              ...
              u = e.radius,
              d = e.x,
              c = e.y;e.skip || (void 0 === t || i.x >= t.left && 1.01 * t.right >= i.x && i.y >= t.top && 1.01 * t.bottom >= i.y) && (a.strokeStyle = e.borderColor || o, a.lineWidth = r.valueOrDefault(e.borderWidth, n.global.elements.point.borderWidth), a.fillStyle = e.backgroundColor || o, r.canvas.drawPoint(a, s, u, d, c, l));
        } });
        ...
        var e,
          ...
          var t,
            ...
            var d = Math.min(Math.abs(t - e), Math.abs(i - n)),
              ...
              v = ["bottom", "left", "top", "right"].indexOf(o, 0);function b(t) {
            return m[(v + t) % 4];
          }-1 === v && (v = 0);var y = b(0);s.moveTo(y[0], y[1]);for (var x = 1; x < 4; x++) {
      ...
      "use strict";
      var n = t(43);i = e.exports = { clear: function clear(t) {
          t.ctx.clearRect(0, 0, t.width, t.height);
        }, roundedRect: function roundedRect(t, e, i, n, a, r) {
          if (r) {
            var o = Math.min(r, a / 2 - 1e-7, n / 2 - 1e-7);t.moveTo(e + o, i), t.lineTo(e + n - o, i), t.arcTo(e + n, i, e + n, i + o, o), t.lineTo(e + n, i + a - o), t.arcTo(e + n, i + a, e + n - o, i + a, o), t.lineTo(e + o, i + a), t.arcTo(e, i + a, e, i + a - o, o), t.lineTo(e, i + o), t.arcTo(e, i, e + o, i, o), t.closePath(), t.moveTo(e, i);
          } else t.rect(e, i, n, a);
        }, drawPoint: function drawPoint(t, e, i, n, a, r) {
          var o, s, l, u, d, c;if (r = r || 0, !e || "object" != (typeof e === "undefined" ? "undefined" : _typeof(e)) || "[object HTMLImageElement]" !== (o = e.toString()) && "[object HTMLCanvasElement]" !== o) {
            if (!(isNaN(i) || i <= 0)) {
              switch (t.save(), t.translate(n, a), t.rotate(r * Math.PI / 180), t.beginPath(), e) {default:
                  t.arc(0, 0, i, 0, 2 * Math.PI), t.closePath();break;case "triangle":
                  d = (s = 3 * i / Math.sqrt(3)) * Math.sqrt(3) / 2, t.moveTo(-s / 2, d / 3), t.lineTo(s / 2, d / 3), t.lineTo(0, -2 * d / 3), t.closePath();break;case "rect":
                  c = 1 / Math.SQRT2 * i, t.rect(-c, -c, 2 * c, 2 * c);break;case "rectRounded":
                  var h = i / Math.SQRT2,
                      f = -h,
                      p = -h,
                      g = Math.SQRT2 * i;this.roundedRect(t, f, p, g, g, .425 * i);break;case "rectRot":
                  c = 1 / Math.SQRT2 * i, t.moveTo(-c, 0), t.lineTo(0, c), t.lineTo(c, 0), t.lineTo(0, -c), t.closePath();break;case "cross":
                  t.moveTo(0, i), t.lineTo(0, -i), t.moveTo(-i, 0), t.lineTo(i, 0);break;case "crossRot":
                  l = Math.cos(Math.PI / 4) * i, u = Math.sin(Math.PI / 4) * i, t.moveTo(-l, -u), t.lineTo(l, u), t.moveTo(-l, u), t.lineTo(l, -u);break;case "star":
                  t.moveTo(0, i), t.lineTo(0, -i), t.moveTo(-i, 0), t.lineTo(i, 0), l = Math.cos(Math.PI / 4) * i, u = Math.sin(Math.PI / 4) * i, t.moveTo(-l, -u), t.lineTo(l, u), t.moveTo(-l, u), t.lineTo(l, -u);break;case "line":
                  t.moveTo(-i, 0), t.lineTo(i, 0);break;case "dash":
                  t.moveTo(0, 0), t.lineTo(i, 0);}t.fill(), t.stroke(), t.restore();
            }
      ...
      "use strict";
      var n = t(43);e.exports = { toLineHeight: function toLineHeight(t, e) {
      ...
      var n = t(46),
        ...
        var u,
          ...
          if (g.resizer) {
            var e = t.parentNode;e && e !== m.parentNode && e.insertBefore(m, e.firstChild), m._reset();
          }
        });
      }function m(t) {
        var e = t[a] || {},
      ...
      var n = t(26),
          a = t(41),
          r = t(46);n._set("global", { plugins: { filler: { propagate: !0 } } });var o = { dataset: function dataset(t) {
          var e = t.fill,
              i = t.chart,
      ...
      var n = t(26),
        ...
        return t.usePointStyle ? e * Math.SQRT2 : t.boxWidth;
          ...
          var t = this,
              ...
              p = t.legendHitBoxes = [],
              g = t.minSize,
              m = t.isHorizontal();if (m ? (g.width = t.maxWidth, g.height = a ? 10 : 0) : (g.width = a ? 10 : 0, g.height = t.maxHeight), a) if (o.font = f, m) {
            var v = t.lineWidths = [0],
              ...
              var a = l(i, d) + d / 2 + o.measureText(e.text).width;v[v.length - 1] + a + i.padding >= t.width && (b += d + i.padding, v[v.length] = t.left), p[n] = { left: 0, top: 0, width: a, height: d }, v[v.length - 1] += a + i.padding;
            }), g.height += b;
          } else {
            var y = i.padding,
                x = t.columnWidths = [],
          ...
          var t = this,
            ...
            var d,
                ...
                v = r.fontString(p, g, m);c.textAlign = "left", c.textBaseline = "middle", c.lineWidth = .5, c.strokeStyle = f, c.fillStyle = f, c.font = v;var b = l(i, p),
                y = t.legendHitBoxes,
              ...
              var f = c.measureText(n.text).width,
                  g = b + p / 2 + f,
                  m = d.x,
                  v = d.y;x ? m + g >= s && (v = d.y += w, d.line++, m = d.x = t.left + (s - u[d.line]) / 2) : v + w > t.bottom && (m = d.x = m + t.columnWidths[d.line] + i.padding, v = d.y = t.top + i.padding, d.line++), function (t, i, n) {
                if (!(isNaN(b) || b <= 0)) {
      ...
      var n = t(26),
          ...
          var t = this,
            ...
            var s,
                ...
                b = t.left,
                y = t.bottom,
                x = t.right;e.fillStyle = i(a.fontColor, o.defaultFontColor), e.font = f, t.isHorizontal() ? (l = b + (x - b) / 2, u = v + g, s = x - b) : (l = "left" === a.position ? b + g : x - g, u = v + (y - v) / 2, s = y - v, m = Math.PI * ("left" === a.position ? -.5 : .5)), e.save(), e.translate(l, u), e.rotate(m), e.textAlign = "center", e.textBaseline = "middle";var w = a.text;if (r.isArray(w)) for (var k = 0, S = 0; S < w.length; ++S) {
      ...
      "use strict";
      var n = t(33),
          a = t(34);e.exports = function () {
        var t = n.extend({ getLabels: function getLabels() {
      ...
      "use strict";
      var n = t(46),
          a = t(33);e.exports = function (t) {
        var e = n.noop;t.LinearScaleBase = a.extend({ getRightValue: function getRightValue(t) {
            ...
            var t = this,
              ...
              var i,
                  a,
                  r,
                  o = [];if (t.stepSize && t.stepSize > 0) r = t.stepSize;else {
                var s = n.niceNum(e.max - e.min, !1);r = n.niceNum(s / (t.maxTicks - 1), !0), void 0 !== (a = t.precision) && (i = Math.pow(10, a), r = Math.ceil(r * i) / i);
              }var l = Math.floor(e.min / r) * r,
                  u = Math.ceil(e.max / r) * r;n.isNullOrUndef(t.min) || n.isNullOrUndef(t.max) || !t.stepSize || n.almostWhole((t.max - t.min) / t.stepSize, r / 1e3) && (l = t.min, u = t.max);var d = (u - l) / r;d = n.almostEquals(d, Math.round(d), r / 1e3) ? Math.round(d) : Math.ceil(d), a = 1, r < 1 && (a = Math.pow(10, 1 - Math.floor(n.log10(r))), l = Math.round(l * a) / a, u = Math.round(u * a) / a), o.push(void 0 !== t.min ? t.min : l);for (var c = 1; c < d; ++c) {
            ...
            var t = this;t.ticksAsNumbers = t.ticks.slice(), t.zeroLineIndex = t.ticks.indexOf(0), a.prototype.convertTicksToLabels.call(t);
          } });
      };
      ...
      var n = t(46),
        ...
        var e = { position: "left", ticks: { callback: o.formatters.logarithmic } },
            i = a.extend({ determineDataLimits: function determineDataLimits() {
            var t = this,
                e = t.options,
                i = t.chart,
                a = i.data.datasets,
      ...
      var n = t(26),
          ...
          return a.isNumber(t) ? t : 0;
        }var p = t.LinearScaleBase.extend({ setDimensions: function setDimensions() {
            var t = this,
                i = t.options,
            ...
            var t, e;this.options.pointLabels.display ? function (t) {
              var e,
                  ...
                  p,
                  g = s(t);for (e = 0; e < g; e++) {
                n = t.getPointPosition(e, o), h = t.ctx, f = r.size, p = t.pointLabels[e] || "", i = a.isArray(p) ? { w: a.longestText(h, h.font, p), h: p.length * f + 1.5 * (p.length - 1) * f } : { w: h.measureText(p).width, h: f }, t._pointLabelSizes[e] = i;var m = t.getIndexAngle(e),
                    v = a.toDegrees(m) % 360,
                    b = u(v, n.x, i.w, 0, 180),
                    y = u(v, n.y, i.h, 90, 270);b.start < d.l && (d.l = b.start, c.l = m), b.end > d.r && (d.r = b.end, c.r = m), y.start < d.t && (d.t = y.start, c.t = m), y.end > d.b && (d.b = y.end, c.b = m);
            ...
            var n = e.l / Math.sin(i.l),
                ...
                r = -e.t / Math.cos(i.t),
                o = -Math.max(e.b - this.height, 0) / Math.cos(i.b);n = f(n), a = f(a), r = f(r), o = f(o), this.drawingArea = Math.min(Math.round(t - (n + a) / 2), Math.round(t - (r + o) / 2)), this.setCenterPoint(n, a, r, o);
            ...
            var t = this,
                ...
                n = i.gridLines,
                r = i.ticks,
                o = a.valueOrDefault;if (i.display) {
              var u = t.ctx,
                  ...
                  v = a.fontString(p, g, m);a.each(t.ticks, function (i, l) {
                if (l > 0 || r.reverse) {
                  var d = t.getDistanceFromCenterForValue(t.ticksAsNumbers[l]);if (n.display && 0 !== l && function (t, e, i, n) {
                    var r = t.ctx;if (r.strokeStyle = a.valueAtIndexOrDefault(e.color, n - 1), r.lineWidth = a.valueAtIndexOrDefault(e.lineWidth, n - 1), t.options.gridLines.circular) r.beginPath(), r.arc(t.xCenter, t.yCenter, i, 0, 2 * Math.PI), r.closePath(), r.stroke();else {
                      var o = s(t);if (0 === o) return;r.beginPath();var l = t.getPointPosition(0, i);r.moveTo(l.x, l.y);for (var u = 1; u < o; u++) {
                        l = t.getPointPosition(u, i), r.lineTo(l.x, l.y);
                      }r.closePath(), r.stroke();
                    }
                  }(t, n, d, l), r.display) {
                    var c = o(r.fontColor, e.defaultFontColor);if (u.font = v, u.save(), u.translate(t.xCenter, t.yCenter), u.rotate(f), r.showLabelBackdrop) {
                      var h = u.measureText(i).width;u.fillStyle = r.backdropColor, u.fillRect(-h / 2 - r.backdropPaddingX, -d - p / 2 - r.backdropPaddingY, h + 2 * r.backdropPaddingX, p + 2 * r.backdropPaddingY);
                ...
                var i = t.ctx,
                    n = t.options,
                    r = n.angleLines,
                    o = n.pointLabels;i.lineWidth = r.lineWidth, i.strokeStyle = r.color;var u = t.getDistanceFromCenterForValue(n.ticks.reverse ? t.min : t.max),
                    f = l(t);i.textBaseline = "top";for (var p = s(t) - 1; p >= 0; p--) {
                  if (r.display) {
                    var g = t.getPointPosition(p, u);i.beginPath(), i.moveTo(t.xCenter, t.yCenter), i.lineTo(g.x, g.y), i.stroke(), i.closePath();
                  }if (o.display) {
                    var m = t.getPointPosition(p, u + 5),
                        v = a.valueAtIndexOrDefault(o.fontColor, p, e.defaultFontColor);i.font = f.font, i.fillStyle = v;var b = t.getIndexAngle(p),
                        y = a.toDegrees(b);i.textAlign = d(y), h(y, t._pointLabelSizes[p], m), c(i, t.pointLabels[p] || "", m, f.size);
                  }
                }
              }(t);
            }
      ...
      "use strict";
      var n = t(1);n = "function" == typeof n ? n : window.moment;var a = t(26),
          r = t(46),
          o = t(33),
          s = t(34),
          ...
          c = Object.keys(d);function h(t, e) {
        return t - e;
      }function f(t) {
        var e,
            i,
        ...
        if (r.isNullOrUndef(t)) return null;var i = e.options.time,
            n = g(e.getRightValue(t), i);return n.isValid() ? (i.round && n.startOf(i.round), n.valueOf()) : null;
      }function v(t) {
        ...
        var o,
          ...
          var a,
              r,
              o,
              s = c.length;for (a = c.indexOf(t); a < s - 1; ++a) {
          ...
          var a,
              ...
              l = d[i],
              u = l.size,
              c = l.steps;if (!c) return Math.ceil(s / (n * u));for (a = 0, r = c.length; a < r && (o = c[a], !(Math.ceil(s / (u * o)) <= n)); ++a) {}return o;
        ...
        var t = o.extend({ initialize: function initialize() {
            if (!n) throw new Error("Chart.js - Moment.js could not be found! You must include it before Chart.js to use the time scale. Download at https://momentjs.com");this.mergeTicksOptions(), o.prototype.initialize.call(this);
          }, update: function update() {
            var t = this.options;return t.time && t.time.format && console.warn("options.time.format is deprecated and replaced by options.time.parser."), o.prototype.update.apply(this, arguments);
          }, getRightValue: function getRightValue(t) {
            ...
            var t,
                ...
                y = [],
                x = [],
                w = [];for (t = 0, i = c.data.labels.length; t < i; ++t) {
              w.push(m(c.data.labels[t], d));
            }for (t = 0, i = (c.data.datasets || []).length; t < i; ++t) {
              if (c.isDatasetVisible(t)) {
                if (o = c.data.datasets[t].data, r.isObject(o[0])) for (x[t] = [], e = 0, a = o.length; e < a; ++e) {
            ...
            var t,
                ...
                l = s.time,
                u = [],
                h = [];switch (s.ticks.source) {case "data":
                u = a._timestamps.data;break;case "labels":
                u = a._timestamps.labels;break;case "auto":default:
                u = b(r, o, a.getLabelCapacity(r), s);}for ("ticks" === s.bounds && u.length && (r = u[0], o = u[u.length - 1]), r = m(l.min, a) || r, o = m(l.max, a) || o, t = 0, e = u.length; t < e; ++t) {
              (i = u[t]) >= r && i <= o && h.push(i);
            }return a.min = r, a.max = o, a._unit = l.unit || function (t, e, i, a) {
              var r,
                  o,
                  s = n.duration(n(a).diff(n(i)));for (r = c.length - 1; r >= c.indexOf(e); r--) {
              ...
              var r,
                  o,
                  s = 0,
                  l = 0;return a.offset && e.length && (a.time.min || (r = e.length > 1 ? e[1] : n, o = e[0], s = (p(t, "time", r, "pos") - p(t, "time", o, "pos")) / 2), a.time.max || (r = e[e.length - 1], o = e.length > 1 ? e[e.length - 2] : i, l = (p(t, "time", r, "pos") - p(t, "time", o, "pos")) / 2)), { left: s, right: l };
            }(a._table, h, r, o, s), a._labelFormat = function (t, e) {
              var i,
                  n,
                  a,
                  r = t.length;for (i = 0; i < r; i++) {
                if (0 !== (n = g(t[i], e)).millisecond()) return "MMM D, YYYY h:mm:ss.SSS a";0 === n.second() && 0 === n.minute() && 0 === n.hour() || (a = !0);
            ...
            var i = this.chart.data,
                ...
                o = i.datasets[e].data[t];return r.isObject(o) && (a = this.getRightValue(o)), n.tooltipFormat ? g(a, n).format(n.tooltipFormat) : "string" == typeof a ? a : g(a, n).format(this._labelFormat);
            ...
            var a = this.options,
                ...
                p = t.format(n || (f ? d : l)),
                g = f ? h : a.ticks.minor,
                m = r.valueOrDefault(g.callback, g.userCallback);return m ? m(p, e, i) : p;
            ...
            var e = this,
                ...
                a = p(e._table, "time", t, "pos");return n + i * (e._offsets.left + a) / (e._offsets.left + 1 + e._offsets.right);
          }, getPixelForValue: function getPixelForValue(t, e, i) {
            var n = null;if (void 0 !== e && void 0 !== i && (n = this._timestamps.datasets[i][e]), null === n && (n = m(t, this)), null !== n) return this.getPixelForOffset(n);
          }, getPixelForTick: function getPixelForTick(t) {
            ...
            var e = this,
                ...
                o = p(e._table, "pos", r, "time");return n(o);
  ...
  var t = t || {},
    ...
    var e = "";for (var i in t) {
      ...
      var e = t.parentNode;if ("span" !== e.tagName.toLowerCase() || !e.classList.contains("waves-effect")) {
        var i = document.createElement("span");i.className = "waves-input-wrapper", e.replaceChild(i, t), i.appendChild(t);
      }
    }, img: function img(t) {
  ...
  var e,
    ...
    var e = t.siblings("label, i"),
        i = t.val().length,
        n = t.attr("placeholder");e["".concat(i || n ? "add" : "remove", "Class")]("active");
  },
      r = function r(t) {
    if (t.hasClass("validate")) {
      ...
      o = function o() {
    var e = t(_this);if (e.val().length) {
      var i = t(".hiddendiv"),
          n = e.css("font-family"),
          a = e.css("font-size");a && i.css("font-size", a), n && i.css("font-family", n), "off" === e.attr("wrap") && i.css("overflow-wrap", "normal").css("white-space", "pre"), i.text("".concat(e.val(), "\n"));var r = i.html().replace(/\n/g, "<br>");i.html(r), i.css("width", e.is(":visible") ? e.width() : t(window).width() / 2), e.css("height", i.height());
    }
  };t(n).each(function (e, i) {
    var n = t(i),
        r = n.siblings("label, i");a(n), i.validity.badInput && r.addClass("active");
    ...
    var i = t(e.target),
        ...
        o = void 0 === i.attr("placeholder");n && a && o && i.siblings("label, i").removeClass("active"), r(i);
  }), t(document).on("change", n, function (e) {
    var i = t(e.target);a(i), r(i);
  }), t("input[autofocus]").siblings("label, i").addClass("active"), t(document).on("reset", function (e) {
    var i = t(e.target);i.is("form") && (i.find(n).removeClass("valid").removeClass("invalid").each(function (e, i) {
      var n = t(i),
          a = !n.val(),
  ...
  }));var s = t("body");if (!t(".hiddendiv").first().length) {
    var l = t('<div class="hiddendiv common"></div>');s.append(l);
  ...
  t(".input-default-wrapper").on("change", ".input-default-js", function (e) {
    var i = t(e.target),
        n = i.next("label"),
        a = i[0].files,
        r = "";a && a.length > 1 ? r = (i.attr("data-multiple-target") || "").replace("{target}", a.length) : e.target.value && (r = e.target.value.split("\\").pop()), r ? n.find(".span-choose-file").html(r) : n.html(n.html());
  });
}(jQuery);
